...
"Flush" konusuna bakıldığında, asında Hibernate'in "unit of work" pattern'ini işlettiğini görebiliriz. RAM'de tuttuğu, ve henüz database'e fiziksel olarak atmadığı SQL'ler "unit of work" pattern'ine tekabül eder.

Notlar:
- unit of work pattern'i transactional olabilir veya olmayabilir.
- Unit of work pattern'i spring-data'daki "batch" özelliği ile de çalışabilir veya batch'siz de işletilebilir. (batch konusu başka balıkta anlatılıyor)
