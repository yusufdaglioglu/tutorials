...
PostgreSQL'deki LIMIT keyword'ü, Microsoft-SQL'deki TOP keyword'üne tekabıl ediyor. Fakat Microsoft-SQL'de OFFSET ile TOP keyword'ü aynı SQL sorgusunda kullanılamazken, PostgreSQL'de yukarıdaki örnekte olduğu gibi kullanılabiliyor.
